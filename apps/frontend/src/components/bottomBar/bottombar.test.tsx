...
describe('BottomBar', () => {
  ...
  describe('Component Structure and Props', () => {
    ...
    test('should verify correct action index mapping', () => {
      ...
      expect(screen.getByTestId('bottom-nav-action-smoke')).toHaveAttribute(
        'data-action-index',
        '0'
      );
      expect(screen.getByTestId('bottom-nav-action-review')).toHaveAttribute(
        'data-action-index',
        '1'
      );
      expect(screen.getByTestId('bottom-nav-action-settings')).toHaveAttribute(
        'data-action-index',
        '2'
      );
    });
